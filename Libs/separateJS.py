...
def splitJSFile(fileContents, outDirectory):
    ...
    outFilename = "setup.js" # Initial output filename
    firstChunk = True
    firstChunkWrapped = False
    buff = ""
    
    outFilename = os.path.join(outDirectory, outFilename)
...
def printHelp():
    ...
    print()
    print("    python3 %s fileName.js [--help|--out file]" % sys.argv[0])
    print("  --help,-h   \t Print this help message.")
    print("  --out,-o    \t The name of the directory to write to (defaults to ./).")
...
if __name__ == "__main__":
    ...
    if 'help' in args:
        ...
        splitJSFile(fileContents, outDirectory)
